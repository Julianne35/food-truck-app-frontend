...
const Options = () => {
  ...
  return (
    <>
      <Wrapper>
{/* if user clicks on search employees button on main page, endpoint === /options-emp */}
...
{/* if user clicks on search customers button on main page, endpoint === /options-comp */}
